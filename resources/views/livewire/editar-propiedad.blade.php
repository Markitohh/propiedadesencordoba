<form class="md:w-1/2 space-y-5" enctype="multipart/form-data" novalidate wire:submit.prevent="editarPropiedad">
    ...
    <div>
        ...
        <div class="my-5">
            ...
            <img src="{{ asset('storage/propiedades/portadas/' . $imagen) }}" alt="{{'Imagen actual de ' . $titulo}}">
        </div>

        <div class="my-5">
            @if ($imagenNueva)
                <p>Imagen seleccionada: <img src="{{ $imagenNueva->temporaryUrl() }}" alt="Imagen seleccionada"></p>
            @endif
        </div>
